...
namespace WineSite.Web.Migrations
{
    ...
    [Migration("20240412065726_Message")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WineSite.Data.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6c5dd852-4692-4653-92cb-3683d013fd37",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAECmOEpWqlgkQ1qFbNdJfeSTg9MkwO0HYp9dO1ut1aCqJ7FhB1+yyodYzkedEpP1fVQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "8134e338-ee08-4e31-8c31-19792980542b",
                            TwoFactorEnabled = false,
                            UserName = "ivana.burgilova@gmail.com"
                        });
                });

            modelBuilder.Entity("WineSite.Data.Data.Models.Events", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WineSite.Data.Data.Models.Messages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WineSite.Data.Data.Models.Orders", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WineSite.Data.Data.Models.OrderWines", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WineSite.Data.Data.Models.Recipe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WineSite.Data.Data.Models.TicketBuyer", b =>
                {
                    b.Property<int>("EventId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WineSite.Data.Data.Models.TicketDelivery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WineSite.Data.Data.Models.Type", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WineSite.Data.Data.Models.Wine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WineSite.Data.Data.Models.WineBuyers", b =>
                {
                    b.Property<int>("WineId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WineSite.Data.Data.Models.WineDelivery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WineSite.Data.Data.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WineSite.Data.Data.Models.Orders", b =>
                {
                    b.HasOne("WineSite.Data.Data.Models.ApplicationUser", "Buyer")
                        .WithMany()
                        .HasForeignKey("BuyerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WineSite.Data.Data.Models.Events", "Events")
                        .WithMany()
            ...
            modelBuilder.Entity("WineSite.Data.Data.Models.OrderWines", b =>
                {
                    ...
                    b.HasOne("WineSite.Data.Data.Models.Wine", "Wines")
                        .WithMany()
            ...
            modelBuilder.Entity("WineSite.Data.Data.Models.Wine", b =>
                {
                    b.HasOne("WineSite.Data.Data.Models.Type", "Type")
                        .WithMany("Wines")
            ...
            modelBuilder.Entity("WineSite.Data.Data.Models.WineBuyers", b =>
                {
                    ...
                    b.HasOne("WineSite.Data.Data.Models.Wine", "Wine")
                        .WithMany()
                        .HasForeignKey("WineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
